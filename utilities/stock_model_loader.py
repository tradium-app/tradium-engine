...
class StockModelLoader:
    ...
    def load(self):
        ...
        try:
            ...
            try:
                ts = TimeSeries(
                    key=self.api_key, output_format="pandas", indexing_type="integer"
                )
                stock, meta_data = ts.get_daily_adjusted(
        ...
        if "Adj. Close" not in stock.columns:
            ...
            stock["Adj. Open"] = (
                stock["1. open"] * stock["5. adjusted close"] / stock["4. close"]
            )
            stock["Adj. Volume"] = (
                stock["6. volume"] * stock["4. close"] / stock["5. adjusted close"]
            )
            stock["Adj. High"] = (
                stock["2. high"] * stock["5. adjusted close"] / stock["4. close"]
            )
            stock["Adj. Close"] = (
                stock["4. close"] * stock["5. adjusted close"] / stock["4. close"]
            )
